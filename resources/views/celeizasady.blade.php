...
<div class="container o_nas_kontakt">
    ...
    <div class="intro">
        ...
        <img src="{{ asset('images/work-life-balance.jpg') }}" alt="Fundacja Dobre Serce" class="img-right">
    </div>
    ...
    <div class="gallery">
        <img src="{{ asset('images/family_4.jpg') }}" alt="Pomoc dzieciom">
        <img src="{{ asset('images/family-2535059_1280.jpg') }}" alt="Edukacja">
        <img src="{{ asset('images/home_family.jpg') }}" alt="Rehabilitacja">
        <img src="{{ asset('images/kid_visit.jpg') }}" alt="Rozwój talentów">
        <img src="{{ asset('images/motherandbaby.jpg') }}" alt="Równość szans">
        <img src="{{ asset('images/team-spirit.jpg') }}" alt="Działania długoterminowe">
    </div>
    ...
    <div class="bottom-image">
        <img src="{{ asset('images/pet.jpg') }}" alt="Pomoc dzieciom">
        <img src="{{ asset('images/family_4.jpg') }}" alt="Pomoc dzieciom">
    </div>
