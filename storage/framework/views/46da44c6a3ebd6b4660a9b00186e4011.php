<?php $__env->startSection('title', 'Projekty'); ?>
...
<div class="projekty-container">
    ...
    <div class="news-section">
        <?php $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="news-card">
                <h2><?php echo e($item['title']); ?></h2>
                <p><?php echo e(Str::limit($item['content'], 100)); ?></p>
                <a href="<?php echo e(route('projekty.show', $id)); ?>" class="btn">Czytaj dalej</a>
            </div>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ROG\OneDrive\Dokumenty\GitHub\fundacja-projekt\resources\views/projekty.blade.php ENDPATH**/ ?>